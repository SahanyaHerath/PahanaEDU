    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <nav class="mt-8 px-4">
            <div class="space-y-2">
                ...
                <a href="product?action=list" class="flex items-center px-4 py-3 text-primary-600 bg-primary-50 rounded-lg font-medium">
    ...
    <div class="lg:ml-64">
        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="product?action=add" class="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 transition-colors duration-200 flex items-center">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <c:if test="${empty products}">
                    <div class="text-center py-12">
                        ...
                        <a href="product?action=add" class="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 transition-colors duration-200">
                            Add Product
                        </a>
                    </div>
                </c:if>
