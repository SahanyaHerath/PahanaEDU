            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Create a new educational product for your inventory</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                    ...
                    <form action="product?action=add" method="post" class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Enter a descriptive name for your educational product</p>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Set the price in Sri Lankan Rupees</p>
                        </div>

                        <!-- Quantity Field -->
                        <div class="relative">
                            <label for="quantity" class="block text-sm font-semibold text-gray-700 mb-3">
                                <i class="fas fa-boxes mr-2 text-primary-600"></i>Quantity in Stock
                            </label>
                            <div class="relative">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Enter the number of units available in stock</p>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="description" name="description" 
                                      placeholder="Enter detailed description of the product (optional)" 
                                      class="form-input w-full px-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-700 placeholder-gray-500 transition-all duration-200 bg-white min-h-[120px] resize-none"></textarea>
                            <p class="mt-2 text-sm text-gray-500">Provide additional details about the product features and benefits</p>
                        </div>

                        <!-- Form Actions -->
                        <div class="flex items-center gap-4 pt-6 border-t border-gray-200">
                            <button type="submit" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                <i class="fas fa-save mr-2"></i>Add Product
                            </button>
                            <a href="product?action=list" class="bg-gray-100 text-gray-700 px-8 py-4 rounded-xl hover:bg-gray-200 transition-all duration-200 flex items-center">
