    ...
    <div class="lg:ml-64">
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Bill Management</h1>
                        <p class="text-sm text-gray-600">Manage invoices and billing records</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="bill?action=create" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                <form method="get" action="bill" class="space-y-3">
                    ...
                    <c:if test="${not empty param.search}">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="bill?action=list" class="text-primary-600 hover:text-primary-700 text-xs font-medium">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        ...
                        <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                            <tr>
                                <th class="px-8 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                    <i class="fas fa-file-invoice-dollar mr-2"></i>Bill Info
                                </th>
                                <th class="px-8 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                            ...
                            <c:forEach var="bill" items="${bills}">
                                <tr class="table-row hover:bg-gray-50 transition-all duration-200 cursor-pointer">
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-14 h-14 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl flex items-center justify-center mr-4 shadow-sm">
                                                <i class="fas fa-file-invoice-dollar text-purple-600 text-xl"></i>
                                            </div>
                                            <div>
                                                <div class="text-lg font-semibold text-gray-900">Bill #${bill.billId}</div>
                                                <div class="text-sm text-gray-500 capitalize flex items-center">
                                                    <i class="fas fa-circle text-green-500 mr-1 text-xs"></i>${bill.status}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500 flex items-center">
                                            <i class="fas fa-credit-card mr-1"></i>Acc: ${bill.accountNumber}
                                        </div>
                                    </td>
                                    <td class="px-8 py-6 whitespace-nowrap">
                ...
                <c:if test="${empty bills}">
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">No bills found</h3>
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Get started by creating your first invoice for a customer.</p>
                        <a href="bill?action=create" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
