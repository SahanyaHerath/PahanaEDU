    ...
    <div class="lg:ml-64">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage your customer database and information</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="customer?action=add" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                <form method="get" action="customer" class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-1/2 relative">
                            ...
                            <input type="text" name="search" value="${param.search}" 
                                   placeholder="Search customers by name, telephone, or account number..." 
                    ...
                    <c:if test="${not empty param.search}">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="customer?action=list" class="text-primary-600 hover:text-primary-700 text-xs font-medium">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            ...
                            <c:forEach var="customer" items="${customers}">
                                <tr class="table-row hover:bg-gray-50 transition-all duration-200 cursor-pointer">
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-14 h-14 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center mr-4 shadow-sm">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-500 flex items-center space-x-4">
                                                    <span class="flex items-center">
                                                        <i class="fas fa-hashtag mr-1"></i>ID: ${customer.customerId}
                                                    </span>
                                                    <span class="flex items-center">
                                                        <i class="fas fa-credit-card mr-1"></i>Acc: ${customer.accountNumber}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-900">${customer.telephone}</span>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
                ...
                <c:if test="${empty customers}">
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Get started by adding your first customer to the system.</p>
                        <a href="customer?action=add" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
