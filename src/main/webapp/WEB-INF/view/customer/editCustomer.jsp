    ...
    <div class="lg:ml-64">
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4"><button onclick="toggleSidebar()" class="lg:hidden text-gray-500 hover:text-gray-700"><i class="fas fa-bars text-xl"></i></button><h1 class="text-2xl font-bold text-gray-900">Edit Customer</h1></div>
        ...
        <div class="p-6">
            ...
            <c:if test="${not empty customer}">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4 text-gray-700">
                        <strong>Editing:</strong> ${customer.name} • <span class="text-gray-600">Account:</span> ${customer.accountNumber}
                    </div>
                    ...
                    <form action="customer" method="post" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="accountNumber" name="accountNumber" required value="${customer.accountNumber}" readonly class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg">
                        </div>

                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Customer Name</label>
                            <input type="text" id="name" name="name" required value="${customer.name}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        </div>

                        <div>
                            <label for="address" class="block text-sm font-medium text-gray-700 mb-2">Address</label>
                            <textarea id="address" name="address" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 min-h-[120px]">${customer.address}</textarea>
                        </div>

                        <div>
                            <label for="telephone" class="block text-sm font-medium text-gray-700 mb-2">Telephone</label>
                            <input type="tel" id="telephone" name="telephone" required value="${customer.telephone}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        </div>

                        <div class="flex items-center gap-3 pt-2">
                            <button type="submit" class="bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition-colors duration-200 flex items-center"><i class="fas fa-save mr-2"></i>Update Customer</button>
