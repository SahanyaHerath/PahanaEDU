            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Create a new customer account in the system</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Fill in the details below to add a new customer</p>
                            </div>
                        </div>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 mb-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-green-700">Generated Account Number</p>
                                            <p class="text-lg font-bold text-green-800">${accountNumber}</p>
                                        </div>
                                    </div>
                                    <div class="bg-green-100 rounded-lg px-3 py-1">
                                        <span class="text-green-700 text-sm font-medium">Auto-generated</span>
                                    </div>
                                </div>
                            </div>
                        </c:if>
                    ...
                    <form action="customer" method="post" class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <input type="text" id="accountNumber" name="accountNumber" required value="${accountNumber}" readonly 
                                       class="form-input w-full px-4 py-4 border border-gray-300 rounded-xl bg-gray-50 text-gray-700">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <i class="fas fa-lock text-gray-400"></i>
                                </div>
                            </div>
                            <p class="mt-2 text-sm text-gray-500">This account number is automatically generated</p>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <input type="text" id="name" name="name" required placeholder="Enter customer full name" value="${param.name}" 
                        ...
                        <div class="relative">
                            ...
                            <textarea id="address" name="address" required placeholder="Enter complete customer address" 
                                      class="form-input w-full px-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-700 placeholder-gray-500 transition-all duration-200 bg-white min-h-[120px] resize-none">${param.address}</textarea>
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <input type="tel" id="telephone" name="telephone" required placeholder="Enter telephone number" value="${param.telephone}" 
                                       class="form-input w-full px-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-gray-700 placeholder-gray-500 transition-all duration-200 bg-white">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
