            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">View comprehensive information about this user</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary-100">User ID: ${user.userId}</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="bg-white bg-opacity-20 rounded-xl px-4 py-2">
                                    <span class="text-white text-sm font-medium capitalize">${user.role}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                            ...
                            <div class="info-card bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-2xl font-bold text-purple-700 capitalize">${user.role}</div>
                                        <div class="text-purple-600 text-sm">User permissions level</div>
                                    </div>
                        ...
                        <!-- Status Section -->
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-6 mb-8">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-green-200 rounded-xl flex items-center justify-center mr-4">
                                        <i class="fas fa-check-circle text-green-600 text-xl"></i>
                                    </div>
                                    <div>
                                        <h3 class="text-xl font-semibold text-green-900">Account Status</h3>
                                        <p class="text-green-700">Active and operational</p>
                                    </div>
                                </div>
                                <div class="bg-green-200 rounded-lg px-4 py-2">
