            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Create a new user account in the system</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Fill in the details below to add a new user</p>
                            </div>
                        </div>
                    </div>

                    <form action="user-management?action=add" method="post" class="space-y-6">
                        <!-- Username Field -->
                        <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Re-enter your password to confirm</p>
                        </div>
