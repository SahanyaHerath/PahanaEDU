            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">View comprehensive information about this product</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary-100">Product ID: ${product.productId}</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="bg-white bg-opacity-20 rounded-xl px-4 py-2">
                                    <span class="text-white text-sm font-medium">Active</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            <div class="info-card bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <div class="text-orange-600 text-sm font-semibold mb-1">
                                            <i class="fas fa-boxes mr-2"></i>Quantity
                                        </div>
                                        <div class="text-3xl font-bold text-orange-700">${product.quantity}</div>
                                        <div class="text-orange-600 text-sm">units in stock</div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-blue-600 text-sm">
                                            <c:choose>
                                                <c:when test="${product.quantity > 0}">Available for purchase</c:when>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
                            ...
                            <div class="text-gray-800 whitespace-pre-line min-h-[80px] leading-relaxed">
                                <c:choose>
