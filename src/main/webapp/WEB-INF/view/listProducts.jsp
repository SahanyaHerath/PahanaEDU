    ...
    <div class="lg:ml-64">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage your educational products and materials</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="product?action=add" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                <form method="get" action="product" class="space-y-3">
                    ...
                    <c:if test="${not empty param.search}">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="product?action=list" class="text-primary-600 hover:text-primary-700 text-xs font-medium">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            ...
                            <c:forEach var="product" items="${products}">
                                <tr class="table-row hover:bg-gray-50 transition-all duration-200 cursor-pointer">
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-14 h-14 bg-gradient-to-br from-green-100 to-green-200 rounded-xl flex items-center justify-center mr-4 shadow-sm">
                                    ...
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-lg font-bold text-orange-700">${product.quantity}</div>
                                                <div class="text-xs text-orange-600">units in stock</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6 whitespace-nowrap">
                ...
                <c:if test="${empty products}">
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">No products found</h3>
                        <p class="text-gray-500 mb-6 max-w-md mx-auto">Get started by adding your first educational product to the system.</p>
                        <a href="product?action=add" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
